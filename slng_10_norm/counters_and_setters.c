...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   counters_and_setters.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: ksudzilo <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/12 17:43:35 by ksudzilo          #+#    #+#             */
/*   Updated: 2023/08/12 17:43:37 by ksudzilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	no_space(int player_count, int exit_count, int collectable, int empty_space)
{
	...
	{
		if (empty_space == 0)
			ft_printf("Error: no space to move\n");
		return (1);
	}
	return (0);
}
...
void	get_collect_count(t_data *data, int *collect_count)
{
	...
	if (!(*collect_count))
	{
		ft_printf("Error: Collectables (C) not found!\n");
		exit(1);
	}
}
