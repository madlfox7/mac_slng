...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/08/12 17:39:41 by ksudzilo          #+#    #+#             */
/*   Updated: 2023/08/12 18:27:37 by ksudzilo         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	validate_map(t_data *data, t_map_val_data *map_data)
{
	int	y;
	int	x;
