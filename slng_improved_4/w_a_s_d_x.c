...
void	w_is_pressed(t_data *data)
{
	...
	if (data->mapp[data->player_x - 1][data->player_y] == 'E')
	{
		if (win_case(data))
		{
	...
	if (data->mapp[data->player_x - 1][data->player_y] != '1')
	{
...
void	a_is_pressed(t_data *data)
{
	...
	if (data->mapp[data->player_x][data->player_y - 1] == 'E')
	{
		if (win_case(data))
		{
			printf("Cheers! You did it)\nTechie is grateful and "
				"wishing u a bug-free coding experience💻\n");
			exit(0);
		}
		return ;
	}
	if (data->mapp[data->player_x][data->player_y - 1] != '1')
	{
...
void	d_is_pressed(t_data *data)
{
	...
	if (data->mapp[data->player_x][data->player_y + 1] == 'E')
	{
		if (win_case(data))
		{
			printf("Cheers! You helped Techie get to the computer and "
